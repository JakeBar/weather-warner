...
WEATHER_BIT_API_KEY = os.environ.get("WEATHER_BIT_API_KEY", "fece651f3db440bfaf971cabec436684")
...
PERCENTAGE_OF_PRECIPITATION_THRESHOLD = os.environ.get("PERCENTAGE_OF_PRECIPITATION_THRESHOLD", 18)
WIND_SPEED_THRESHOLD = os.environ.get("WIND_SPEED_THRESHOLD", 12)
MAX_TEMP_THRESHOLD = os.environ.get("MAX_TEMP_THRESHOLD", 35)
MIN_TEMP_THRESHOLD = os.environ.get("MIN_TEMP_THRESHOLD", 2)
